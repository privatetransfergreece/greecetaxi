...
const content = routeContent.routeThessalonikiAirportHyattRegency.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeThessalonikiAirportHyattRegency", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeThessalonikiAirportHyattRegency", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ThessalonikiAirportHyattRegencyRoutePage() {
