...
const content = routeContent.routeHeraklionAirportMinosBeachArt.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeHeraklionAirportMinosBeachArt", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeHeraklionAirportMinosBeachArt", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function HeraklionAirportMinosBeachArtRoutePage() {
  ...
  return (
    <LocationPage
      ...
      breadcrumbItems={[
        { label: "Home", href: "/" },
        { label: "Agios Nikolaos", href: pathFor("cityAgiosNikolaos", "en") },
