...
import { Clock, Landmark, MapPin, PlaneTakeoff, Route as RouteIcon, Users } from "lucide-react";
...
const content = routeContent.routeAthensAirportCorinth.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeAthensAirportCorinth", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeAthensAirportCorinth", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function AthensAirportCorinthRoutePage() {
  ...
  return (
    ...
    >
      ...
      <ServiceFeatures content={content.journeyPlanning} icons={[Clock, RouteIcon, PlaneTakeoff, MapPin]} />
      <ServiceFeatures content={content.whoItSuits} icons={[MapPin, Landmark, Users]} />
      <RelatedLinks eyebrow={content.relatedLinks.eyebrow} title={content.relatedLinks.title} items={content.relatedLinks.items.map((item, i) => ({ ...item, icon: [PlaneTakeoff, MapPin][i] }))} />
