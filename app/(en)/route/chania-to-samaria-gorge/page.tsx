...
const content = routeContent.routeChaniaSamariaGorge.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeChaniaSamariaGorge", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeChaniaSamariaGorge", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ChaniaSamariaGorgeRoutePage() {
