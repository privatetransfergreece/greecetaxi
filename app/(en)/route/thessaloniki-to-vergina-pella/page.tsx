...
const content = routeContent.routeThessalonikiVerginaPella.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeThessalonikiVerginaPella", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeThessalonikiVerginaPella", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ThessalonikiVerginaPellaRoutePage() {
