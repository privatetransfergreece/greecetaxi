...
const content = routeContent.routeChaniaAirportPlatanias.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeChaniaAirportPlatanias", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeChaniaAirportPlatanias", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ChaniaAirportPlataniasRoutePage() {
