...
const content = routeContent.routeThessalonikiAirportPortoCarras.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeThessalonikiAirportPortoCarras", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeThessalonikiAirportPortoCarras", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ThessalonikiAirportPortoCarrasRoutePage() {
  ...
  return (
    <LocationPage
      ...
      breadcrumbItems={[
        { label: "Home", href: "/" },
        { label: "Sithonia", href: pathFor("destinationSithonia", "en") },
