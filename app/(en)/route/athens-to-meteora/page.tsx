...
import { Clock, Luggage, Route as RouteIcon, CalendarClock, Users } from "lucide-react";
...
const content = routeContent.routeAthensMeteora.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeAthensMeteora", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeAthensMeteora", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function AthensMeteoraRoutePage() {
  ...
  return (
    ...
    >
      ...
      <ServiceFeatures content={content.journeyPlanning} icons={[Clock, RouteIcon, Luggage, CalendarClock]} />
      <ServiceFeatures content={content.whoItSuits} icons={[CalendarClock, Users, Clock]} />
