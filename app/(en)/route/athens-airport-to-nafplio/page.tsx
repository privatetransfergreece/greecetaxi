...
const content = routeContent.routeAthensAirportNafplio.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeAthensAirportNafplio", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeAthensAirportNafplio", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function AthensAirportNafplioRoutePage() {
  ...
  return (
    ...
    >
      ...
      <ServiceFeatures content={content.whoItSuits} icons={[MapPin, Users, RouteIcon]} />
