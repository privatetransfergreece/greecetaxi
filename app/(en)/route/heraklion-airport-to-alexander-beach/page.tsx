...
const content = routeContent.routeHeraklionAirportAlexanderBeach.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeHeraklionAirportAlexanderBeach", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeHeraklionAirportAlexanderBeach", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function HeraklionAirportAlexanderBeachRoutePage() {
  ...
  return (
    <LocationPage
      ...
      breadcrumbItems={[
        { label: "Home", href: "/" },
        { label: "Malia", href: pathFor("destinationMalia", "en") },
