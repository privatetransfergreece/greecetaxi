...
import { Clock, Luggage, MapPin, PlaneTakeoff, Route as RouteIcon, Users } from "lucide-react";
...
const content = routeContent.routeAthensAirportVouliagmeni.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeAthensAirportVouliagmeni", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeAthensAirportVouliagmeni", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function AthensAirportVouliagmeniRoutePage() {
  ...
  return (
    ...
    >
      ...
      <ServiceFeatures content={content.whoItSuits} icons={[MapPin, Users, Luggage]} />
      <RelatedLinks eyebrow={content.relatedLinks.eyebrow} title={content.relatedLinks.title} items={content.relatedLinks.items.map((item, i) => ({ ...item, icon: [MapPin, PlaneTakeoff][i] }))} />
