...
import { Briefcase, Clock, Luggage, MapPin, PlaneTakeoff, Route as RouteIcon, Users } from "lucide-react";
...
const content = routeContent.routeAthensAirportGlyfada.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeAthensAirportGlyfada", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeAthensAirportGlyfada", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function AthensAirportGlyfadaRoutePage() {
  ...
  return (
    ...
    >
      ...
      <ServiceFeatures content={content.whoItSuits} icons={[MapPin, Briefcase, Users]} />
