...
import { Briefcase, Clock, Luggage, Route as RouteIcon, Users } from "lucide-react";
...
const content = routeContent.routeAthensThessaloniki.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeAthensThessaloniki", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeAthensThessaloniki", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function AthensThessalonikiRoutePage() {
  ...
  return (
    ...
    >
      ...
      <ServiceFeatures content={content.journeyPlanning} icons={[Clock, RouteIcon, Luggage, Clock]} />
      <ServiceFeatures content={content.whoItSuits} icons={[Briefcase, Users, Clock]} />
      <RelatedLinks eyebrow={content.relatedLinks.eyebrow} title={content.relatedLinks.title} items={content.relatedLinks.items.map((item, i) => ({ ...item, icon: [RouteIcon, RouteIcon][i] }))} />
