...
import { Building2, Clock, MapPin, Repeat, Route as RouteIcon, Sun, Users } from "lucide-react";
...
const content = routeContent.routeAthensCapeSounion.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeAthensCapeSounion", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeAthensCapeSounion", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function AthensCapeSounionRoutePage() {
  ...
  return (
    ...
    >
      ...
      <ServiceFeatures content={content.journeyPlanning} icons={[Clock, RouteIcon, Repeat, Sun]} />
      <ServiceFeatures content={content.whoItSuits} icons={[Sun, RouteIcon, Users]} />
