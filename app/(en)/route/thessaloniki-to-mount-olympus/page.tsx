...
const content = routeContent.routeThessalonikiMountOlympus.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeThessalonikiMountOlympus", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeThessalonikiMountOlympus", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ThessalonikiMountOlympusRoutePage() {
