...
const content = routeContent.routeThessalonikiKavala.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeThessalonikiKavala", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeThessalonikiKavala", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ThessalonikiKavalaRoutePage() {
