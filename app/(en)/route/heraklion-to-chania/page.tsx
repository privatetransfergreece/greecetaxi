...
import { Clock, Luggage, PlaneTakeoff, Route as RouteIcon, Users } from "lucide-react";
...
const content = routeContent.routeHeraklionChania.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeHeraklionChania", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeHeraklionChania", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function HeraklionChaniaRoutePage() {
  ...
  return (
    ...
    >
      ...
      <ServiceFeatures content={content.whoItSuits} icons={[PlaneTakeoff, RouteIcon, Users]} />
      <RelatedLinks eyebrow={content.relatedLinks.eyebrow} title={content.relatedLinks.title} items={content.relatedLinks.items.map((item, i) => ({ ...item, icon: [PlaneTakeoff, PlaneTakeoff, RouteIcon][i] }))} />
