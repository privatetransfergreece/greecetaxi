...
const content = routeContent.routeThessalonikiAirportPort.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeThessalonikiAirportPort", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeThessalonikiAirportPort", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ThessalonikiAirportPortRoutePage() {
