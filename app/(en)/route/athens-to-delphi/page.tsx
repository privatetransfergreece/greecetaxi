...
const content = routeContent.routeAthensDelphi.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeAthensDelphi", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeAthensDelphi", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function AthensDelphiRoutePage() {
  ...
  return (
    ...
    >
      ...
      <ServiceFeatures content={content.whoItSuits} icons={[RouteIcon, Users, Clock]} />
