...
const content = routeContent.routeHeraklionAirportNanaPrincess.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeHeraklionAirportNanaPrincess", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeHeraklionAirportNanaPrincess", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function HeraklionAirportNanaPrincessRoutePage() {
  ...
  return (
    <LocationPage
      ...
      breadcrumbItems={[
        { label: "Home", href: "/" },
        { label: "Hersonissos", href: pathFor("destinationHersonissos", "en") },
