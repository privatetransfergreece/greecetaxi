...
const content = routeContent.routeChaniaAirportGeorgioupolis.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeChaniaAirportGeorgioupolis", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeChaniaAirportGeorgioupolis", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ChaniaAirportGeorgioupolisRoutePage() {
