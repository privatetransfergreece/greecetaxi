...
const content = routeContent.routeChaniaAirportRethymno.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeChaniaAirportRethymno", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeChaniaAirportRethymno", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ChaniaAirportRethymnoRoutePage() {
