...
const content = routeContent.routeThessalonikiStations.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeThessalonikiStations", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeThessalonikiStations", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ThessalonikiStationsRoutePage() {
