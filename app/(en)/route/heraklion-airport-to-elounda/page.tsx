...
const content = routeContent.routeHeraklionAirportElounda.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeHeraklionAirportElounda", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeHeraklionAirportElounda", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function HeraklionAirportEloundaRoutePage() {
