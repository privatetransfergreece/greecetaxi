...
const content = portContent.portPiraeus.en;
...
export const metadata: Metadata = {
  ...
  alternates: localizedAlternates("portPiraeus", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("portPiraeus", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function PiraeusPortPage() {
