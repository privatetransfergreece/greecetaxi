...
const content = serviceHubs.cityToCityTransfers.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("cityToCityTransfers", "en"),
  openGraph: {
    title: meta.title,
    description: meta.description,
    url: absoluteUrl(pathFor("cityToCityTransfers", "en")),
  },
...
export default function CityToCityTransfersPage() {
  return (
    <ServiceHubPage slug="cityToCityTransfers" locale="en">
