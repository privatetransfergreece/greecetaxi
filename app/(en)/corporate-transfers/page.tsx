...
const content = serviceHubs.corporateTransfers.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("corporateTransfers", "en"),
  openGraph: {
    title: meta.title,
    description: meta.description,
    url: absoluteUrl(pathFor("corporateTransfers", "en")),
  },
...
export default function CorporateTransfersPage() {
  return (
    <ServiceHubPage slug="corporateTransfers" locale="en">
