...
const content = airportContent.chaniaAirport.en;
...
export const metadata: Metadata = {
  ...
  alternates: localizedAlternates("chaniaAirport", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("chaniaAirport", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ChaniaAirportPage() {
  ...
  return (
    ...
    >
      ...
      <RelatedLinks eyebrow={content.connections.eyebrow} title={content.connections.title} items={content.connections.items.map((item, i) => ({ ...item, icon: [PlaneTakeoff, Ship][i] }))} />
