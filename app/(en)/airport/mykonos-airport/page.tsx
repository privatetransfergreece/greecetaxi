...
const content = airportContent.mykonosAirport.en;
const image = airportImages.mykonosAirport;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("mykonosAirport", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("mykonosAirport", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function MykonosAirportPage() {
  const quoteHref = pathFor("getQuote", "en");

  return (
    <LocationPage
      pageKey="mykonosAirport"
      locale="en"
      title={meta.title}
      description={meta.description}
      breadcrumbItems={[
