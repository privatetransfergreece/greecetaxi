...
const content = airportContent.corfuAirport.en;
const image = airportImages.corfuAirport;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("corfuAirport", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("corfuAirport", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function CorfuAirportPage() {
  const quoteHref = pathFor("getQuote", "en");

  return (
    <LocationPage
      pageKey="corfuAirport"
      locale="en"
      title={meta.title}
      description={meta.description}
      breadcrumbItems={[
