...
const content = airportContent.heraklionAirport.en;
const image = airportImages.heraklionAirport;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("heraklionAirport", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("heraklionAirport", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function HeraklionAirportPage() {
  const quoteHref = pathFor("getQuote", "en");

  return (
    <LocationPage
      pageKey="heraklionAirport"
      locale="en"
      title={meta.title}
      description={meta.description}
      breadcrumbItems={[
