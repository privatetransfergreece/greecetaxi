...
const content = airportContent.rhodesAirport.en;
const image = airportImages.rhodesAirport;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("rhodesAirport", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("rhodesAirport", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function RhodesAirportPage() {
  const quoteHref = pathFor("getQuote", "en");

  return (
    <LocationPage
      pageKey="rhodesAirport"
      locale="en"
      title={meta.title}
      description={meta.description}
      breadcrumbItems={[
