...
const content = airportContent.thessalonikiAirport.en;
...
export const metadata: Metadata = {
  ...
  alternates: localizedAlternates("thessalonikiAirport", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("thessalonikiAirport", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ThessalonikiAirportPage() {
