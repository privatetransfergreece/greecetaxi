...
const content = airportContent.athensAirport.en;
...
export const metadata: Metadata = {
  ...
  alternates: localizedAlternates("athensAirport", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("athensAirport", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function AthensAirportPage() {
