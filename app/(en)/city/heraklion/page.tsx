...
const content = cityContent.cityHeraklion.en;
...
export const metadata: Metadata = {
  ...
  alternates: localizedAlternates("cityHeraklion", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("cityHeraklion", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function HeraklionCityPage() {
