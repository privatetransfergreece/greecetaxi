...
const content = serviceHubs.hourlyHire.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("hourlyHire", "en"),
  openGraph: {
    title: meta.title,
    description: meta.description,
    url: absoluteUrl(pathFor("hourlyHire", "en")),
  },
...
export default function HourlyHirePage() {
  return (
    <ServiceHubPage slug="hourlyHire" locale="en">
