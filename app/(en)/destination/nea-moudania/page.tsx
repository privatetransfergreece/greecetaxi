...
const content = destinationContent.destinationNeaMoudania.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("destinationNeaMoudania", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("destinationNeaMoudania", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function NeaMoudaniaDestinationPage() {
  ...
  return (
    <LocationPage
      ...
      breadcrumbItems={[
        { label: "Home", href: "/" },
        { label: "Halkidiki", href: pathFor("destinationHalkidiki", "en") },
