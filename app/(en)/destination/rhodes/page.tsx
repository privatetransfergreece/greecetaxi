...
const content = destinationContent.destinationRhodes.en;
...
export const metadata: Metadata = {
  ...
  alternates: localizedAlternates("destinationRhodes", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("destinationRhodes", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function RhodesDestinationPage() {
