...
const content = destinationContent.destinationSantorini.en;
...
export const metadata: Metadata = {
  ...
  alternates: localizedAlternates("destinationSantorini", "en"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("destinationSantorini", "en")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function SantoriniDestinationPage() {
