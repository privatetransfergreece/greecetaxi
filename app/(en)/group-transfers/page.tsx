...
const content = serviceHubs.groupTransfers.en;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("groupTransfers", "en"),
  openGraph: {
    title: meta.title,
    description: meta.description,
    url: absoluteUrl(pathFor("groupTransfers", "en")),
  },
...
export default function GroupTransfersPage() {
  return (
    <ServiceHubPage slug="groupTransfers" locale="en">
