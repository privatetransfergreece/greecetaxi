...
const content = cityContent.cityRethymno.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("cityRethymno", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("cityRethymno", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function RethymnoCityPageEl() {
  const quoteHref = pathFor("getQuote", "el");

  return (
    <LocationPage
      pageKey="cityRethymno"
      locale="el"
      title={meta.title}
      description={meta.description}
      breadcrumbItems={[
