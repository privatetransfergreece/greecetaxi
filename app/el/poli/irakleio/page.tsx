...
const content = cityContent.cityHeraklion.el;
const image = cityImages.cityHeraklion!;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("cityHeraklion", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("cityHeraklion", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function HeraklionCityPageEl() {
  const quoteHref = pathFor("getQuote", "el");

  return (
    <LocationPage
      pageKey="cityHeraklion"
      locale="el"
      title={meta.title}
      description={meta.description}
      breadcrumbItems={[
