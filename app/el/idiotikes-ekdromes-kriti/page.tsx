...
const content = destinationContent.creteDayTrips.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("creteDayTrips", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("creteDayTrips", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function CreteDayTripsDestinationPageEl() {
  const quoteHref = pathFor("getQuote", "el");

  return (
    <LocationPage
      pageKey="creteDayTrips"
      locale="el"
      title={meta.title}
      description={meta.description}
      breadcrumbItems={[
