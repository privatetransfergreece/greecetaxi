...
const content = airportContent.rhodesAirport.el;
...
export const metadata: Metadata = {
  ...
  alternates: localizedAlternates("rhodesAirport", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("rhodesAirport", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function RhodesAirportPageEl() {
