...
const content = airportContent.mykonosAirport.el;
...
export const metadata: Metadata = {
  ...
  alternates: localizedAlternates("mykonosAirport", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("mykonosAirport", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function MykonosAirportPageEl() {
