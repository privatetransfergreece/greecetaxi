...
const content = airportContent.corfuAirport.el;
...
export const metadata: Metadata = {
  ...
  alternates: localizedAlternates("corfuAirport", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("corfuAirport", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function CorfuAirportPageEl() {
