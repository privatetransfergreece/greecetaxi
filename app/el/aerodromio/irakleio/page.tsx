...
const content = airportContent.heraklionAirport.el;
...
export const metadata: Metadata = {
  ...
  alternates: localizedAlternates("heraklionAirport", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("heraklionAirport", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function HeraklionAirportPageEl() {
