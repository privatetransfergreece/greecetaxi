...
const content = airportContent.santoriniAirport.el;
...
export const metadata: Metadata = {
  ...
  alternates: localizedAlternates("santoriniAirport", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("santoriniAirport", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function SantoriniAirportPageEl() {
