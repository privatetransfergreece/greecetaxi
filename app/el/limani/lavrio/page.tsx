...
const content = portContent.portLavrio.el;
...
export const metadata: Metadata = {
  ...
  alternates: localizedAlternates("portLavrio", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("portLavrio", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function LavrioPortPageEl() {
