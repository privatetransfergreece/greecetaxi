...
const content = destinationsHubContent.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("destinationsHub", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("destinationsHub", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function DestinationsHubPageEl() {
  return (
    <LocationPage
      ...
      title={meta.title}
      description={meta.description}
      breadcrumbItems={[{ label: "Αρχική", href: "/el/" }, { label: "Προορισμοί" }]}
