...
const content = routeContent.routeAthensThessaloniki.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeAthensThessaloniki", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeAthensThessaloniki", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function AthensThessalonikiRoutePageEl() {
