...
const content = routeContent.routeAthensCapeSounion.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeAthensCapeSounion", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeAthensCapeSounion", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function AthensCapeSounionRoutePageEl() {
