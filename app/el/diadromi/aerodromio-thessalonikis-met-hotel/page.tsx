...
const content = routeContent.routeThessalonikiAirportMetHotel.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeThessalonikiAirportMetHotel", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeThessalonikiAirportMetHotel", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ThessalonikiAirportMetHotelRoutePageEl() {
