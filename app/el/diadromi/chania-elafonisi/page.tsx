...
const content = routeContent.routeChaniaElafonissi.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeChaniaElafonissi", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeChaniaElafonissi", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ChaniaElafonissiRoutePageEl() {
