...
const content = routeContent.routeThessalonikiAirportMediterraneanPalace.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeThessalonikiAirportMediterraneanPalace", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeThessalonikiAirportMediterraneanPalace", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ThessalonikiAirportMediterraneanPalaceRoutePageEl() {
  ...
  return (
    <LocationPage
      ...
      breadcrumbItems={[
        ...
        { label: "Θεσσαλονίκη", href: pathFor("cityThessaloniki", "el") },
