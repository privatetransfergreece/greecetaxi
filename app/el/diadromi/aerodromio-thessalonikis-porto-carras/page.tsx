...
const content = routeContent.routeThessalonikiAirportPortoCarras.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeThessalonikiAirportPortoCarras", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeThessalonikiAirportPortoCarras", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ThessalonikiAirportPortoCarrasRoutePageEl() {
  ...
  return (
    <LocationPage
      ...
      breadcrumbItems={[
        ...
        { label: "Σιθωνία", href: pathFor("destinationSithonia", "el") },
