...
const content = routeContent.routeThessalonikiHalkidiki.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeThessalonikiHalkidiki", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeThessalonikiHalkidiki", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ThessalonikiHalkidikiRoutePageEl() {
