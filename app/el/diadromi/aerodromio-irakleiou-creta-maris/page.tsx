...
const content = routeContent.routeHeraklionAirportCretaMaris.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeHeraklionAirportCretaMaris", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeHeraklionAirportCretaMaris", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function HeraklionAirportCretaMarisRoutePageEl() {
