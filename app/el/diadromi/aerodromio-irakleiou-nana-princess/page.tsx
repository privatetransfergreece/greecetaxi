...
const content = routeContent.routeHeraklionAirportNanaPrincess.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeHeraklionAirportNanaPrincess", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeHeraklionAirportNanaPrincess", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function HeraklionAirportNanaPrincessRoutePageEl() {
  ...
  return (
    <LocationPage
      ...
      breadcrumbItems={[
        ...
        { label: "Χερσόνησος", href: pathFor("destinationHersonissos", "el") },
