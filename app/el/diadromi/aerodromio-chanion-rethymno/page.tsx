...
const content = routeContent.routeChaniaAirportRethymno.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeChaniaAirportRethymno", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeChaniaAirportRethymno", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ChaniaAirportRethymnoRoutePageEl() {
