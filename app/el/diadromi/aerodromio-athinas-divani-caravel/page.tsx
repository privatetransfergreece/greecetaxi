...
const content = routeContent.routeAthensAirportDivaniCaravel.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeAthensAirportDivaniCaravel", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeAthensAirportDivaniCaravel", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function AthensAirportDivaniCaravelRoutePageEl() {
  ...
  return (
    ...
    >
      ...
      <ServiceFeatures content={content.whoItSuits} icons={[Building2, Building2, Users]} />
