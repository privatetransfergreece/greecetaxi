...
const content = routeContent.routeHeraklionAirportAlexanderBeach.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeHeraklionAirportAlexanderBeach", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeHeraklionAirportAlexanderBeach", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function HeraklionAirportAlexanderBeachRoutePageEl() {
  ...
  return (
    <LocationPage
      ...
      breadcrumbItems={[
        ...
        { label: "Μάλια", href: pathFor("destinationMalia", "el") },
