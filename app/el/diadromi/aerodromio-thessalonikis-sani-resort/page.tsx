...
const content = routeContent.routeThessalonikiAirportSaniResort.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeThessalonikiAirportSaniResort", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeThessalonikiAirportSaniResort", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ThessalonikiAirportSaniResortRoutePageEl() {
  ...
  return (
    <LocationPage
      ...
      breadcrumbItems={[
        ...
        { label: "Κασσάνδρα", href: pathFor("destinationKassandra", "el") },
