...
const content = routeContent.routeChaniaAirportGeorgioupolis.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeChaniaAirportGeorgioupolis", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeChaniaAirportGeorgioupolis", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ChaniaAirportGeorgioupolisRoutePageEl() {
