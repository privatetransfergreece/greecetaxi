...
const content = routeContent.routeHeraklionAirportLegacyGastroSuites.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeHeraklionAirportLegacyGastroSuites", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeHeraklionAirportLegacyGastroSuites", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function HeraklionAirportLegacyGastroSuitesRoutePageEl() {
