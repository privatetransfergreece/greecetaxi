...
const content = routeContent.routeAthensAirportGrandeBretagne.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeAthensAirportGrandeBretagne", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeAthensAirportGrandeBretagne", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function AthensAirportGrandeBretagneRoutePageEl() {
  ...
  return (
    ...
    >
      ...
      <ServiceFeatures content={content.whoItSuits} icons={[Building2, Users, Building2]} />
