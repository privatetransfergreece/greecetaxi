...
const content = routeContent.routeThessalonikiPortHalkidiki.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeThessalonikiPortHalkidiki", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeThessalonikiPortHalkidiki", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ThessalonikiPortHalkidikiRoutePageEl() {
