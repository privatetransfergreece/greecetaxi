...
const content = routeContent.routeAthensAirportNjvPlaza.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeAthensAirportNjvPlaza", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeAthensAirportNjvPlaza", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function AthensAirportNjvPlazaRoutePageEl() {
  ...
  return (
    ...
    >
      ...
      <ServiceFeatures content={content.whoItSuits} icons={[Building2, Users, Users]} />
