...
const content = routeContent.routeThessalonikiKavala.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeThessalonikiKavala", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeThessalonikiKavala", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ThessalonikiKavalaRoutePageEl() {
