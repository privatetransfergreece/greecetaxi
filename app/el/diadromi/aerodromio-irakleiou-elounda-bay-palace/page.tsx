...
const content = routeContent.routeHeraklionAirportEloundaBayPalace.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeHeraklionAirportEloundaBayPalace", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeHeraklionAirportEloundaBayPalace", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function HeraklionAirportEloundaBayPalaceRoutePageEl() {
  ...
  return (
    <LocationPage
      ...
      breadcrumbItems={[
        ...
        { label: "Ελούντα", href: pathFor("destinationElounda", "el") },
