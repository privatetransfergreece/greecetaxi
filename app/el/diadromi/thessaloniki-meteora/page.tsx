...
const content = routeContent.routeThessalonikiMeteora.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeThessalonikiMeteora", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeThessalonikiMeteora", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ThessalonikiMeteoraRoutePageEl() {
