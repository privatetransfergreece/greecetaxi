...
const content = routeContent.routeThessalonikiVerginaPella.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeThessalonikiVerginaPella", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeThessalonikiVerginaPella", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ThessalonikiVerginaPellaRoutePageEl() {
