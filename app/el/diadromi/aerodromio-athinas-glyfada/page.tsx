...
const content = routeContent.routeAthensAirportGlyfada.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeAthensAirportGlyfada", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeAthensAirportGlyfada", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function AthensAirportGlyfadaRoutePageEl() {
