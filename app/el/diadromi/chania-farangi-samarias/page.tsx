...
const content = routeContent.routeChaniaSamariaGorge.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeChaniaSamariaGorge", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeChaniaSamariaGorge", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ChaniaSamariaGorgeRoutePageEl() {
