...
const content = routeContent.routeHeraklionAirportMinosBeachArt.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeHeraklionAirportMinosBeachArt", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeHeraklionAirportMinosBeachArt", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function HeraklionAirportMinosBeachArtRoutePageEl() {
  ...
  return (
    <LocationPage
      ...
      breadcrumbItems={[
        ...
        { label: "Άγιος Νικόλαος", href: pathFor("cityAgiosNikolaos", "el") },
