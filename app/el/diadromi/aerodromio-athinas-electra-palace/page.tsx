...
import { Building2, Clock, MapPin, PlaneTakeoff, Route as RouteIcon } from "lucide-react";
...
const content = routeContent.routeAthensAirportElectraPalace.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("routeAthensAirportElectraPalace", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("routeAthensAirportElectraPalace", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function AthensAirportElectraPalaceRoutePageEl() {
  ...
  return (
    ...
    >
      ...
      <ServiceFeatures content={content.whoItSuits} icons={[MapPin, Building2, Building2]} />
      <RelatedLinks eyebrow={content.relatedLinks.eyebrow} title={content.relatedLinks.title} items={content.relatedLinks.items.map((item, i) => ({ ...item, icon: [PlaneTakeoff, Building2][i] }))} />
