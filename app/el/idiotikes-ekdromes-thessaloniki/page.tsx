...
const content = destinationContent.thessalonikiDayTrips.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("thessalonikiDayTrips", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("thessalonikiDayTrips", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ThessalonikiDayTripsDestinationPageEl() {
