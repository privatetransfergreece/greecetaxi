...
const content = destinationContent.destinationRhodes.el;
const image = destinationImages.destinationRhodes!;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("destinationRhodes", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("destinationRhodes", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function RhodesDestinationPageEl() {
  const quoteHref = pathFor("getQuote", "el");

  return (
    <LocationPage
      pageKey="destinationRhodes"
      locale="el"
      title={meta.title}
      description={meta.description}
      breadcrumbItems={[
      ...
      faq={content.faq}
      extraSchema={[{ "@context": "https://schema.org", "@type": "TouristDestination", name: "Rhodes", description: meta.description }]}
