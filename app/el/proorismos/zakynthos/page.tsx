...
const content = destinationContent.destinationZakynthos.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("destinationZakynthos", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("destinationZakynthos", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function ZakynthosDestinationPageEl() {
  const quoteHref = pathFor("getQuote", "el");

  return (
    <LocationPage
      pageKey="destinationZakynthos"
      locale="el"
      title={meta.title}
      description={meta.description}
      breadcrumbItems={[
      ...
      faq={content.faq}
      extraSchema={[{ "@context": "https://schema.org", "@type": "TouristDestination", name: "Zakynthos", description: meta.description }]}
