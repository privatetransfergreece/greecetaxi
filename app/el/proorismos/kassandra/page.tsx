...
const content = destinationContent.destinationKassandra.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("destinationKassandra", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("destinationKassandra", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function KassandraDestinationPageEl() {
  const quoteHref = pathFor("getQuote", "el");

  return (
    <LocationPage
      pageKey="destinationKassandra"
      locale="el"
      title={meta.title}
      description={meta.description}
      breadcrumbItems={[
      ...
      faq={content.faq}
      extraSchema={[{ "@context": "https://schema.org", "@type": "TouristDestination", name: "Kassandra", description: meta.description }]}
