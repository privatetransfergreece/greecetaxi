...
const content = destinationContent.destinationMykonos.el;
...
export const metadata: Metadata = {
  ...
  alternates: localizedAlternates("destinationMykonos", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("destinationMykonos", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function MykonosDestinationPageEl() {
