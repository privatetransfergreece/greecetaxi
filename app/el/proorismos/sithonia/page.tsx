...
const content = destinationContent.destinationSithonia.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("destinationSithonia", "el"),
  openGraph: { title: meta.title, description: meta.description, url: absoluteUrl(pathFor("destinationSithonia", "el")) },
  twitter: { title: meta.title, description: meta.description },
};

export default function SithoniaDestinationPageEl() {
  const quoteHref = pathFor("getQuote", "el");

  return (
    <LocationPage
      pageKey="destinationSithonia"
      locale="el"
      title={meta.title}
      description={meta.description}
      breadcrumbItems={[
      ...
      faq={content.faq}
      extraSchema={[{ "@context": "https://schema.org", "@type": "TouristDestination", name: "Sithonia", description: meta.description }]}
