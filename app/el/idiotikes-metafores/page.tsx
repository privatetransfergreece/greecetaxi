...
const content = serviceHubs.privateTransfers.el;
const { meta } = content;

export const metadata: Metadata = {
  title: { absolute: meta.title },
  description: meta.description,
  alternates: localizedAlternates("privateTransfers", "el"),
  openGraph: {
    title: meta.title,
    description: meta.description,
    url: absoluteUrl(pathFor("privateTransfers", "el")),
  },
  twitter: { title: meta.title, description: meta.description },
};

export default function PrivateTransfersPageEl() {
  return (
    <ServiceHubPage slug="privateTransfers" locale="el">
