...
export const destinationsHubContent: Record<"en" | "el", DestinationsHubContent> = {
  en: {
    ...
    cities: {
      ...
      items: [
        { label: "Athens", href: "/city/athens/", description: "Greece's capital, the starting point for most transfers across the country." },
  ...
  el: {
    ...
    cities: {
      ...
      items: [
        { label: "Αθήνα", href: "/el/poli/athina/", description: "Η πρωτεύουσα της Ελλάδας, το σημείο εκκίνησης για τις περισσότερες μεταφορές στη χώρα." },
