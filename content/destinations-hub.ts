  ...
  en: {
    ...
    cities: {
      ...
      items: [
        ...
        { label: "Heraklion", href: "/city/heraklion/", description: "Crete's largest city and main commercial hub." },
        { label: "Chania", href: "/city/chania/", description: "The main town of western Crete." },
    ...
    destinations: {
      ...
      items: [
        ...
        { label: "Malia", href: "/destination/malia/", description: "A well-known resort strip further along the coast from Hersonissos." },
    ...
    ports: {
      ...
      items: [
        ...
        { label: "Souda Port", href: "/port/souda/", description: "The port serving Chania and western Crete." },
    ...
    routes: {
      ...
      items: [
        ...
        { label: "Heraklion Airport to Elounda", href: "/route/heraklion-airport-to-elounda/", description: "A direct transfer to Crete's luxury resort enclave." },
        { label: "Heraklion Airport to Chania", href: "/route/heraklion-airport-to-chania/", description: "A direct cross-island airport transfer." },
        { label: "Chania Airport to Platanias", href: "/route/chania-airport-to-platanias/", description: "A direct transfer to the resort strip west of Chania." },
        { label: "Heraklion to Knossos", href: "/route/heraklion-to-knossos/", description: "A short transfer to Crete's most visited archaeological site." },
        { label: "Chania to Elafonissi", href: "/route/chania-to-elafonissi/", description: "A day-trip transfer to one of Crete's best-known beaches." },
      ],
    },
    services: {
      eyebrow: "Services",
      ...
      items: [
        ...
        { label: "Crete Day Trips", href: "/crete-day-trips/", description: "Private day trips across Crete with a flexible itinerary and return journey included where relevant." },
  ...
  el: {
    ...
    cities: {
      ...
      items: [
        ...
        { label: "Χανιά", href: "/el/poli/chania/", description: "Η κύρια πόλη της δυτικής Κρήτης." },
    ...
    destinations: {
      ...
      items: [
        ...
        { label: "Μάλια", href: "/el/proorismos/malia/", description: "Μια γνωστή τουριστική ζώνη πιο μακριά στην ακτή από τον Χερσόνησο." },
    ...
    ports: {
      ...
      items: [
        ...
        { label: "Λιμάνι Σούδας", href: "/el/limani/souda/", description: "Το λιμάνι που εξυπηρετεί τα Χανιά και τη δυτική Κρήτη." },
    ...
    routes: {
      ...
      items: [
        ...
        { label: "Αεροδρόμιο Ηρακλείου προς Χερσόνησο", href: "/el/diadromi/aerodromio-irakleiou-chersonisos/", description: "Απευθείας μεταφορά προς μία από τις μεγαλύτερες περιοχές θερέτρων της Κρήτης." },
        { label: "Αεροδρόμιο Ηρακλείου προς Ελούντα", href: "/el/diadromi/aerodromio-irakleiou-elounda/", description: "Απευθείας μεταφορά προς τον θύλακα πολυτελών θερέτρων της Κρήτης." },
        { label: "Αεροδρόμιο Ηρακλείου προς Χανιά", href: "/el/diadromi/aerodromio-irakleiou-chania/", description: "Απευθείας μεταφορά αεροδρομίου σε όλο το νησί." },
        { label: "Αεροδρόμιο Χανίων προς Πλατανιά", href: "/el/diadromi/aerodromio-chanion-platanias/", description: "Απευθείας μεταφορά προς την τουριστική ζώνη δυτικά των Χανίων." },
        { label: "Ηράκλειο προς Κνωσό", href: "/el/diadromi/irakleio-knosos/", description: "Μια σύντομη μεταφορά προς τον πιο επισκέψιμο αρχαιολογικό χώρο της Κρήτης." },
        { label: "Χανιά προς Ελαφονήσι", href: "/el/diadromi/chania-elafonisi/", description: "Μια μεταφορά εκδρομής προς μία από τις πιο γνωστές παραλίες της Κρήτης." },
      ],
    },
    services: {
      eyebrow: "Υπηρεσίες",
      ...
      items: [
        ...
        { label: "Ιδιωτικές Ημερήσιες Εκδρομές στην Κρήτη", href: "/el/idiotikes-ekdromes-kriti/", description: "Ιδιωτικές ημερήσιες εκδρομές σε όλη την Κρήτη με ευέλικτο πρόγραμμα και την επιστροφή σας συμπεριλαμβανόμενη όπου ισχύει." },
