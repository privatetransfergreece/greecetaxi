  ...
  heraklionAirport: {
    en: {
      ...
      destinations: {
        ...
        items: [
          { label: "Hersonissos", href: "/route/heraklion-airport-to-hersonissos/", description: "A direct transfer to one of Crete's largest resort areas, east of Heraklion." },
          { label: "Malia", href: "/route/heraklion-airport-to-malia/", description: "A direct transfer to the Malia resort strip." },
          { label: "Agios Nikolaos", href: "/route/heraklion-airport-to-agios-nikolaos/", description: "A direct transfer to the main town of eastern Crete." },
          { label: "Elounda", href: "/route/heraklion-airport-to-elounda/", description: "A direct transfer to Elounda's luxury resort area." },
          { label: "Rethymno", href: "/route/heraklion-airport-to-rethymno/", description: "A direct transfer roughly midway to Chania." },
          { label: "Chania", href: "/route/heraklion-airport-to-chania/", description: "A direct transfer along Crete's north coast to Chania, bypassing central Heraklion." },
      ...
      connections: {
        ...
        items: [
          { label: "Heraklion City Centre", href: "/city/heraklion/", description: "Direct transfers between the airport and hotels or addresses across Heraklion." },
          { label: "Heraklion Airport to Port", href: "/route/heraklion-airport-to-port/", description: "A dedicated route page for ferry and cruise connections between the airport and the port." },
      ...
      hotelTransfers: {
        eyebrow: "Hotel Transfers",
        title: "Popular Crete Hotel Transfers",
        items: [
          { label: "GDM Megaron", href: "/route/heraklion-airport-to-gdm-megaron/", description: "Central Heraklion, overlooking the Venetian port." },
          { label: "Aquila Atlantis Hotel", href: "/route/heraklion-airport-to-aquila-atlantis/", description: "Central Heraklion, near the Archaeological Museum." },
          { label: "Olive Green Hotel", href: "/route/heraklion-airport-to-olive-green/", description: "Central Heraklion, near Eleftherias Square." },
          { label: "Legacy Gastro Suites", href: "/route/heraklion-airport-to-legacy-gastro-suites/", description: "Central Heraklion, on Eleftherias Square." },
          { label: "Galaxy Iraklio Hotel", href: "/route/heraklion-airport-to-galaxy-iraklio/", description: "Just outside central Heraklion." },
          { label: "Creta Maris Resort", href: "/route/heraklion-airport-to-creta-maris/", description: "A large all-inclusive resort in Hersonissos." },
          { label: "Nana Princess", href: "/route/heraklion-airport-to-nana-princess/", description: "An adults-only luxury resort in Hersonissos." },
          { label: "Alexander Beach Hotel & Village Resort", href: "/route/heraklion-airport-to-alexander-beach/", description: "A traditional village-style resort near Stalis and Malia." },
          { label: "Elounda Bay Palace", href: "/route/heraklion-airport-to-elounda-bay-palace/", description: "A luxury resort near Elounda on Mirabello Bay." },
          { label: "Elounda Beach Hotel & Villas", href: "/route/heraklion-airport-to-elounda-beach/", description: "A pioneering luxury resort in Elounda village." },
          { label: "Minos Beach Art Hotel", href: "/route/heraklion-airport-to-minos-beach-art/", description: "A design-focused waterfront hotel in Agios Nikolaos." },
        ],
      },
      howPickupWorks: sharedHowItWorksEn,
      travelPlanning: {
    ...
    el: {
      ...
      destinations: {
        ...
        items: [
          { label: "Χερσόνησος", href: "/el/diadromi/aerodromio-irakleiou-chersonisos/", description: "Απευθείας μεταφορά προς μία από τις μεγαλύτερες τουριστικές περιοχές της Κρήτης, ανατολικά του Ηρακλείου." },
          { label: "Μάλια", href: "/el/diadromi/aerodromio-irakleiou-malia/", description: "Απευθείας μεταφορά προς τη τουριστική περιοχή των Μαλίων." },
          { label: "Άγιος Νικόλαος", href: "/el/diadromi/aerodromio-irakleiou-agios-nikolaos/", description: "Απευθείας μεταφορά προς την κύρια πόλη της ανατολικής Κρήτης." },
          { label: "Ελούντα", href: "/el/diadromi/aerodromio-irakleiou-elounda/", description: "Απευθείας μεταφορά προς την περιοχή πολυτελών θερέτρων της Ελούντας." },
          { label: "Ρέθυμνο", href: "/el/diadromi/aerodromio-irakleiou-rethymno/", description: "Απευθείας μεταφορά περίπου στη μέση της διαδρομής προς τα Χανιά." },
          { label: "Χανιά", href: "/el/diadromi/aerodromio-irakleiou-chania/", description: "Απευθείας μεταφορά κατά μήκος της βόρειας ακτής της Κρήτης προς τα Χανιά, παρακάμπτοντας το κέντρο του Ηρακλείου." },
      ...
      connections: {
        ...
        items: [
          { label: "Κέντρο Ηρακλείου", href: "/el/poli/irakleio/", description: "Απευθείας μεταφορές μεταξύ του αεροδρομίου και ξενοδοχείων ή διευθύνσεων σε όλο το Ηράκλειο." },
          { label: "Αεροδρόμιο Ηρακλείου προς Λιμάνι", href: "/el/diadromi/aerodromio-irakleiou-limani/", description: "Ειδική σελίδα διαδρομής για συνδέσεις ferry και κρουαζιέρας μεταξύ αεροδρομίου και λιμανιού." },
      ...
      hotelTransfers: {
        eyebrow: "Μεταφορές σε Ξενοδοχεία",
        title: "Δημοφιλείς Μεταφορές σε Ξενοδοχεία της Κρήτης",
        items: [
          { label: "GDM Megaron", href: "/el/diadromi/aerodromio-irakleiou-gdm-megaron/", description: "Κέντρο Ηρακλείου, με θέα στο Ενετικό λιμάνι." },
          { label: "Aquila Atlantis Hotel", href: "/el/diadromi/aerodromio-irakleiou-aquila-atlantis/", description: "Κέντρο Ηρακλείου, κοντά στο Αρχαιολογικό Μουσείο." },
          { label: "Olive Green Hotel", href: "/el/diadromi/aerodromio-irakleiou-olive-green/", description: "Κέντρο Ηρακλείου, κοντά στην Πλατεία Ελευθερίας." },
          { label: "Legacy Gastro Suites", href: "/el/diadromi/aerodromio-irakleiou-legacy-gastro-suites/", description: "Κέντρο Ηρακλείου, στην Πλατεία Ελευθερίας." },
          { label: "Galaxy Iraklio Hotel", href: "/el/diadromi/aerodromio-irakleiou-galaxy-iraklio/", description: "Λίγο έξω από το κέντρο του Ηρακλείου." },
          { label: "Creta Maris Resort", href: "/el/diadromi/aerodromio-irakleiou-creta-maris/", description: "Ένα μεγάλο all-inclusive θέρετρο στον Χερσόνησο." },
          { label: "Nana Princess", href: "/el/diadromi/aerodromio-irakleiou-nana-princess/", description: "Ένα πολυτελές θέρετρο μόνο για ενήλικες στον Χερσόνησο." },
          { label: "Alexander Beach Hotel & Village Resort", href: "/el/diadromi/aerodromio-irakleiou-alexander-beach/", description: "Ένα θέρετρο σε παραδοσιακό στυλ κοντά στον Σταλίδα και τα Μάλια." },
          { label: "Elounda Bay Palace", href: "/el/diadromi/aerodromio-irakleiou-elounda-bay-palace/", description: "Ένα πολυτελές θέρετρο κοντά στην Ελούντα στον κόλπο Μιραμπέλλο." },
          { label: "Elounda Beach Hotel & Villas", href: "/el/diadromi/aerodromio-irakleiou-elounda-beach/", description: "Ένα από τα πρώτα πολυτελή θέρετρα της Ελούντας." },
          { label: "Minos Beach Art Hotel", href: "/el/diadromi/aerodromio-irakleiou-minos-beach-art/", description: "Ένα παραθαλάσσιο ξενοδοχείο design στον Άγιο Νικόλαο." },
        ],
      },
      howPickupWorks: sharedHowItWorksEl,
      travelPlanning: {
  ...
  chaniaAirport: {
    en: {
      ...
      destinations: {
        ...
        items: [
          { label: "Rethymno", href: "/route/chania-airport-to-rethymno/", description: "A direct transfer roughly midway to Heraklion." },
          { label: "Platanias", href: "/route/chania-airport-to-platanias/", description: "A direct transfer to the resort strip west of Chania town." },
          { label: "Georgioupolis", href: "/route/chania-airport-to-georgioupolis/", description: "A direct transfer to the coastal resort town between Chania and Rethymno." },
      ...
      connections: {
        ...
        title: "Airport and Port Connections",
        items: [
          { label: "Chania City Centre", href: "/city/chania/", description: "Direct transfers between the airport and hotels or addresses across Chania." },
          { label: "Souda Port", href: "/port/souda/", description: "The port serving Chania, a short distance from the airport." },
    ...
    el: {
      ...
      destinations: {
        ...
        items: [
          { label: "Ρέθυμνο", href: "/el/diadromi/aerodromio-chanion-rethymno/", description: "Απευθείας μεταφορά περίπου στη μέση της διαδρομής προς το Ηράκλειο." },
          { label: "Πλατανιάς", href: "/el/diadromi/aerodromio-chanion-platanias/", description: "Απευθείας μεταφορά προς τη τουριστική περιοχή δυτικά της πόλης των Χανίων." },
          { label: "Γεωργιούπολη", href: "/el/diadromi/aerodromio-chanion-georgioupolis/", description: "Απευθείας μεταφορά προς την παράκτια πόλη θερέτρου μεταξύ Χανίων και Ρεθύμνου." },
      ...
      connections: {
        ...
        items: [
          { label: "Κέντρο Χανίων", href: "/el/poli/chania/", description: "Απευθείας μεταφορές μεταξύ του αεροδρομίου και ξενοδοχείων ή διευθύνσεων σε όλα τα Χανιά." },
          { label: "Λιμάνι Σούδας", href: "/el/limani/souda/", description: "Το λιμάνι που εξυπηρετεί τα Χανιά, σε μικρή απόσταση από το αεροδρόμιο." },
