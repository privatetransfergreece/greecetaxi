...
import { airportWhyChooseContent } from "@/content/airport-transfers"
import type { Locale } from "@/lib/i18n/config"

const icons: LucideIcon[] = [DoorOpen, Car, Clock, ShieldCheck, MessagesSquare, Users]

function AirportWhyChoose({ locale }: { locale: Locale }) {
  const t = airportWhyChooseContent[locale]
